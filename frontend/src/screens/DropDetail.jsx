...
const DropDetail = () => {
    ...
    return (
        <div className="min-h-screen bg-white pb-32 lg:pb-12 lg:px-8">
            <div className="lg:flex lg:gap-12 lg:max-w-7xl lg:mx-auto lg:pt-8">
                {/* Left Column: Top Image Section */}
                <div className="lg:w-1/2 lg:sticky lg:top-8 h-fit px-0 lg:px-0">
                    <div className="relative w-full aspect-[4/5] lg:aspect-square bg-[#F7F7F7] overflow-hidden lg:rounded-3xl lg:shadow-2xl">
                        ...
                        <div className="absolute top-6 right-20 z-30 lg:hidden">
                            <Link to="/cart">
                                <motion.button
                ...
                <div className="lg:w-1/2 px-6 py-8 lg:px-0 lg:py-0 space-y-8 flex flex-col">
                    {/* Desktop Headers */}
                    <div className="hidden lg:flex justify-between items-center mb-6">
                        <Link to="/cart">
                            <motion.button
                                animate={isBouncing ? { scale: [1, 1.3, 1] } : {}}
                                transition={{ duration: 0.4, ease: "easeInOut" }}
                                className="px-6 py-2.5 bg-[#10B981]/10 text-[#10B981] rounded-full flex items-center gap-3 font-bold hover:bg-[#10B981]/20 transition-all relative overflow-hidden"
                            >
                                <ShoppingBag size={18} />
                                <span className="text-sm">My Cart ({cart.length})</span>
                            </motion.button>
                        </Link>
                    </div>
                    ...
                    <div className="flex items-start justify-between">
                        <div className="space-y-1">
                            <h1 className="text-2xl lg:text-4xl font-black text-[#1F2937] uppercase tracking-tight leading-none">{drop.name}</h1>
                            <p className="text-sm lg:text-base font-bold text-gray-400 capitalize pt-1">{drop.store_name} • Premium Wear</p>
                        </div>
                    ...
                    {/* Price - Moved up for Desktop Visibility */}
                    <div className="lg:pt-4">
                        <div className="flex flex-col">
                            ...
                            <span className="text-3xl lg:text-5xl font-black text-[#10B981] tracking-tighter">₦{(parseFloat(drop.price) * quantity).toLocaleString()}</span>
                        </div>
                    </div>
                    ...
                    <div className="space-y-3">
                        ...
                        <p className="text-sm lg:text-base text-gray-500 font-bold leading-relaxed tracking-tight">
                    ...
                    {/* Desktop Buttons Integration */}
                    <div className="hidden lg:flex gap-4 pt-8">
                        <button
                            onClick={handlePurchase}
                            className="flex-1 bg-[#10B981] text-white font-black py-4.5 rounded-full shadow-xl shadow-[#10B981]/20 hover:bg-[#0da070] transition-all text-xs uppercase tracking-[0.2em] flex items-center justify-center gap-2 active:scale-[0.98] h-16"
                        >
                            Checkout Now
                        ...
                        <button
                            ...
                            className="flex-1 bg-white border-2 border-[#1F2937] text-[#1F2937] font-black py-4.5 rounded-full hover:bg-gray-50 transition-all text-xs uppercase tracking-[0.1em] flex items-center justify-center gap-2 active:scale-[0.98] h-16"
                        >
                            Add To Cart
            ...
            {/* Sticky Dual Pill Footer (Mobile Only) */}
            <div className="fixed bottom-0 left-0 right-0 p-6 bg-white/90 backdrop-blur-2xl z-50 border-t border-gray-50 lg:hidden">
